...
insert into student (id_card_number, user_id, course_number, group_name, faculty, grade_book_number, deleted,
                     specialization_code)
values
    ('a1a3a2d7-7995-4d2d-bf17-b534a134517d', '5f717f66-469d-485a-9224-b6e78eaaac22', 1, 'МЕН-191015', 'ИЕНиМ', '000001', false, '10.05.01'),
    ('c0d5336c-3c0b-43bf-b751-48cf96b223f3', 'e44cf214-cd62-4eef-b31e-8ba4e479f353', 1, 'МЕН-191015', 'ИЕНиМ', '000002', false, '10.05.01');
...
insert into dean_employee (id, user_id, deleted, job_title, certificate)
values (1, '73db5c34-1fd8-4e09-b2a4-ecac96d64334', false, 'Секретарь', null);